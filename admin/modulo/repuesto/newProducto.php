			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input id="swModifica" name="swModifica" type="hidden" >
						<input id="IDREPUESTOMODIFICA" name="IDREPUESTOMODIFICA" type="hidden" >
					</div>

					<div class="form-group">
						<label for="numParte_" class="control-label col-md-3"># De Parte:</label>
						<div class="col-md-4">
							<input type="text" class="form-control" id="numParte" name="numParte"  onkeyup="BuscarRepuesto()"  placeholder="# de Parte"
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<select id="categoria_" name="categoria_" class="form-control" data-validation="required">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<select id="proveedor_" name="proveedor_" class="form-control" data-validation="required">
					...
					<div class="form-group">
						<label for="detailp" class="control-label col-md-3">Detalle:</label>
						<div class="col-md-9">
					...
					<hr>
					<div class="form-group">
						<label for="detail_p" class="control-label col-md-3 col-xs-3">Asignar a la Sucursal:</label>
