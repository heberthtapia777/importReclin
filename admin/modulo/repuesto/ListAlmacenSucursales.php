<form id="formAlmacenSuc" action="javascript:fDelete('formDelete','delete.php')" class="form-horizontal" autocomplete="off" >
    <div class="modal fade" id="dataAlmacenSuc" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
...
<script>
    $('#dataAlmacenSuc').on('show.bs.modal', function (event) {
